...
var DOMAIN = "headline.zgzsrc.com";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="证才通资讯"; //网站名称
...
var INDEXNAV = [
  { id: '1', name: '资质专区', image: '../../images/nav-icon1.png', url: '../../pages/list/list?categoryID=1059', redirecttype: 'apppage', extraData: '' },
  { id: '2', name: '证书要闻', image: '../../images/nav-icon2.png', url: '../../pages/list/list?categoryID=1059', redirecttype: 'apppage',  extraData: '' },
  { id: '3', name: '考试资讯', image: '../../images/nav-icon3.png', url: '../../pages/list/list?categoryID=1059', redirecttype: 'apppage',  extraData: '' },
  { id: '4', name: '职场资讯', image: '../../images/nav-icon4.png', url: '../../pages/list/list?categoryID=1059', redirecttype: 'apppage',  extraData: ''},
